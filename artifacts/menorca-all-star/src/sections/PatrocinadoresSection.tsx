...
const SPONSORS = [
  { name: 'Tenimpla', logo: logoTenimpla },
  { name: 'IX', logo: logoIX },
];
      ...
      <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-10">
        {SPONSORS.map((sponsor) => (
          <motion.div
            ...
            className="flex items-center justify-center w-52 sm:w-64 h-32 rounded-2xl bg-white border border-white/10 px-8 py-6 shadow-[0_0_40px_rgba(255,255,255,0.04)] hover:shadow-[0_0_50px_rgba(226,18,18,0.15)] transition-shadow duration-500"
          >
            <img
              src={sponsor.logo}
              alt={sponsor.name}
